    ...
    <div style={{
      ...
      <div className="card" style={{ 
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <h1 style={{ fontSize: "2rem", color: "#163321", marginBottom: "0.75rem", fontWeight: "700", letterSpacing: "-0.5px" }}>Create Account</h1>
          <p style={{ color: "#475569", fontSize: "1rem" }}>Join the healthcare revolution</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div className="form-group">
            <label htmlFor="confirmPassword" style={{ color: "#163321", fontWeight: "600", fontSize: "0.9rem", marginBottom: "0.5rem", display: "block" }}>Confirm Password</label>
            <input
              type="password"
              id="confirmPassword"
